...
export type MutationMakeSeenByUserArgs = {
...
export type Query = {
  ...
  shippingAvailableTo: Array<Maybe<Scalars['String']>>;
  getUserInstantMessage?: Maybe<Array<Maybe<InstantMessageType>>>;
};
...
export type QueryGetUserInstantMessageArgs = {
  userEmail: Scalars['String'];
};
...
export namespace GetCms {
  export type Variables = GetCmsQueryVariables;
  export type Query = GetCmsQuery;
  export type GetCms = NonNullable<(NonNullable<GetCmsQuery['getCms']>)[number]>;
  export type FeaturedAsset = (NonNullable<NonNullable<(NonNullable<GetCmsQuery['getCms']>)[number]>['featuredAsset']>);
}

export type GetCmsQueryVariables = Exact<{
...
export type GetCmsQuery = (
  { __typename?: 'Query' }
  & { getCms?: Maybe<Array<Maybe<(
    { __typename?: 'cms' }
    & Pick<Cms, 'id' | 'content' | 'cmsType'>
    & { featuredAsset?: Maybe<(
      { __typename?: 'Asset' }
      & Pick<Asset, 'preview'>
    )> }
