...
export namespace MetricSummary {
  export type Variables = MetricSummaryQueryVariables;
  export type Query = MetricSummaryQuery;
  export type MetricSummary = NonNullable<(NonNullable<MetricSummaryQuery['metricSummary']>)[number]>;
  export type Entries = NonNullable<(NonNullable<NonNullable<(NonNullable<MetricSummaryQuery['metricSummary']>)[number]>['entries']>)[number]>;
}
...
export type MetricSummaryQuery = (
  { __typename?: 'Query' }
  & { metricSummary: Array<(
    { __typename?: 'MetricSummary' }
    & Pick<MetricSummary, 'interval' | 'code' | 'title'>
    & { entries: Array<(
      { __typename?: 'MetricSummaryEntry' }
      & Pick<MetricSummaryEntry, 'label' | 'value'>
    )> }
  )> }
);
