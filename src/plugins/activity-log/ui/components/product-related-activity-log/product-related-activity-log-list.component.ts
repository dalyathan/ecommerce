...
import { DELETE_PRODUCT_ACTIVITY_LOG, PRODUCT_ACTIVITY_LOGS, REVERT_PRODUCT_CHANGE } from '../../activity-log-resolver.graphql';
...
export class ProductRelatedActivityLogListComponent extends ActivityLogActions implements OnInit {
    constructor( dataService: Apollo,  cdr: ChangeDetectorRef,  ns: NotificationService){
        super(cdr,ns,dataService,PRODUCT_ACTIVITY_LOGS,REVERT_PRODUCT_CHANGE,DELETE_PRODUCT_ACTIVITY_LOG);
    }
    ngOnInit(): void {
