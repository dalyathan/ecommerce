...
import { SHIPPING_METHOD_ACTIVITY_LOGS, REVERT_SHIPPING_METHOD_CHANGE, DELETE_SHIPPING_METHOD_ACTIVITY_LOG } from '../../activity-log-resolver.graphql';
...
export class ShippingMethodActivityLogListComponent extends ActivityLogActions implements OnInit {
    constructor( dataService: Apollo,  cdr: ChangeDetectorRef,  ns: NotificationService){
        super(cdr,ns,dataService,SHIPPING_METHOD_ACTIVITY_LOGS,REVERT_SHIPPING_METHOD_CHANGE,DELETE_SHIPPING_METHOD_ACTIVITY_LOG);
    }
    ngOnInit(): void {
