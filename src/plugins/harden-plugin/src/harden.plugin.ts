import { Logger, EtechPlugin, Injector, TransactionalConnection, PluginCommonModule } from '@etech/core';
import {ModuleRef} from '@nestjs/core';
import { HARDEN_PLUGIN_OPTIONS, loggerCtx, TRANSACTIONAL_CONNECTION } from './constants';
...
@EtechPlugin({
    providers: [
        ...
        {
            provide: TRANSACTIONAL_CONNECTION,
            useFactory: () => TransactionalConnection,
        }
    ],
