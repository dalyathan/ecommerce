...
import { createSubscriptionsPermissionDefinition, updateSubscriptionsPermissionDefinition, readSubscriptionsPermissionDefinition, deleteSubscriptionsPermissionDefinition } from '.';

/**
 * An example Etech plugin.
 *
 * @example
 * ```TypeScript
...
@EtechPlugin({
    ...
    // access to the Etech core providers. See https://www.etech.io/docs/typescript-api/plugin/plugin-common-module/
    ...
    configuration: config => {
        config.authOptions.customPermissions.push(readSubscriptionsPermissionDefinition, deleteSubscriptionsPermissionDefinition,
            createSubscriptionsPermissionDefinition, updateSubscriptionsPermissionDefinition);
        return config;
    }
})
