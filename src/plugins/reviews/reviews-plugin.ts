import { LanguageCode, PluginCommonModule, EtechPlugin } from '@etech/core';
...
import {  readReviewsPermissionDefinition, updateReviewsPermissionDefinition } from '.';
...
@EtechPlugin({
    ...
    configuration: config => {
        ...
        config.authOptions.customPermissions.push(readReviewsPermissionDefinition, updateReviewsPermissionDefinition );
        return config;
    },
})
