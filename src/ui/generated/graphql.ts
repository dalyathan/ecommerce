...
export namespace UpsertInvoiceConfig {
  export type Variables = UpsertInvoiceConfigMutationVariables;
  export type Mutation = UpsertInvoiceConfigMutation;
  export type UpsertInvoiceConfig = (NonNullable<UpsertInvoiceConfigMutation['upsertInvoiceConfig']>);
}

export namespace InvoiceConfig {
  export type Variables = InvoiceConfigQueryVariables;
  export type Query = InvoiceConfigQuery;
  export type InvoiceConfig = (NonNullable<InvoiceConfigQuery['invoiceConfig']>);
}

export namespace Invoices {
  export type Variables = InvoicesQueryVariables;
  export type Query = InvoicesQuery;
  export type Invoices = (NonNullable<InvoicesQuery['invoices']>);
  export type Items = NonNullable<(NonNullable<(NonNullable<InvoicesQuery['invoices']>)['items']>)[number]>;
}
...
export type UpsertInvoiceConfigMutation = (
  { __typename?: 'Mutation' }
  & { upsertInvoiceConfig: (
    { __typename?: 'InvoiceConfig' }
    & Pick<InvoiceConfig, 'id' | 'enabled' | 'templateString'>
  ) }
);
...
export type InvoiceConfigQuery = (
  { __typename?: 'Query' }
  & { invoiceConfig?: Maybe<(
    { __typename?: 'InvoiceConfig' }
    & Pick<InvoiceConfig, 'id' | 'enabled' | 'templateString'>
...
export type InvoicesQuery = (
  ...
  & { invoices: (
    { __typename?: 'InvoiceList' }
    & Pick<InvoiceList, 'totalItems'>
    & { items: Array<(
      { __typename?: 'Invoice' }
      & Pick<Invoice, 'id' | 'createdAt' | 'orderCode' | 'orderId' | 'customerEmail' | 'invoiceNumber' | 'downloadUrl'>
    )> }
  ) }
);
